...
syms r1 u0 u1 real
syms A [3 3] real % 这会创建 m1_1, m1_2, ... m10_10 等符号变量并组成矩阵 m
...
if length(all_monomials) ~= 4 && length(monos) == 4 % 确保all_monomials也是120，通常 S_i 为行，拼接后仍为行
